...
<body>
<div class="text-item">
           <h2 id="Our-vision" style="text-align: center; color: #2980b9; font-size: 50px;">CAREER</h2>
     ...
     if ($num > 0) {
      while ($cate = mysqli_fetch_array($queryfire)) {
        ...
        //print_r($cate);?>
              ...
              <div class="row">
                <h3><?php echo $cate['post_name']; ?></h3>
              <hr>
              <div class="col-md-2 col-sm-2 col-xs-12">
                   <div class="date-box">
                       <span style="color: #000; font-size: 20px;"><?php echo $cate['p_date']; ?></span>                                
                   </div>
                 </div>
              </div>
