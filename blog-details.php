...
<div class="container-fluid" style="background-color: #bdc3c7; ">
  <div class="container">
  <?php
     include "config.php";
      $gid = $_GET['id'];
  ...
  <div>
    <h1 style="text-align: center; color: #30336b; font-size: 50px;" ><?php echo $details['title']; ?></h1><hr style="background-color: #2c3e50; height:6px;">
  </div>
  <div>
    <h3 style="text-align: left; color: #30336b; font-size: 40px;" ><?php echo $details['sub_tittle']; ?></h3><br><br>
